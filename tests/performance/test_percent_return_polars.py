...
class TestPlPercentReturn:
    ...
    def test_lazy_execution(self, sample_df):
        ...
        result = lazy_df.select(percent_return("close")).collect()
        assert "PCTRET_1" in result.columns
