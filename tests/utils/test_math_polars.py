...
from polars_ti.utils._math import (
    fibonacci_weights,
    non_zero_range,
    pascals_triangle_weights,
    signed_diff,
    symmetric_triangle_weights,
...
class TestPlNonZeroRange:
    ...
    def test_basic_range(self):
        ...
        result = df.select(non_zero_range("high", "low").alias("range"))
...
class TestPlSignedDiff:
    ...
    def test_increasing_values(self):
        ...
        result = df.select(signed_diff("close").alias("sign"))
...
class TestPlUnsignedDifferences:
    ...
    def test_positive_negative_separation(self):
        ...
        pos, neg = unsigned_differences("close")
...
class TestWeightGenerators:
    ...
    def test_pascals_triangle_weights_sum_to_one(self):
        ...
        weights = pascals_triangle_weights(10)
        assert abs(sum(weights) - 1.0) < 1e-10
