...
class TestPlPsl:
    ...
    def test_returns_expression(self, sample_df):
        ...
        result = sample_df.select(pl_psl("close"))
    ...
    def test_offset_shifts_result(self, sample_df):
        ...
        result = sample_df.select(pl_psl("close", offset=5))
