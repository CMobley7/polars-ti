...
class TestPlZlma:
    ...
    def test_with_null_values(self):
        ...
        result = df.select(zlma("close", length=10))
    ...
    def test_lazy_execution(self, sample_df):
        ...
        result = lazy_df.select(zlma("close", length=10)).collect()
        assert "ZL_EMA_10" in result.columns
