...
def vwmacd(
    ...
    fast_vwma = vwma(close_expr, volume_expr, length=fast, offset=0)
    slow_vwma = vwma(close_expr, volume_expr, length=slow, offset=0)
    ...
    signal_expr = sma(vwmacd_pv, length=signal) / sma(volume_expr, length=signal)
