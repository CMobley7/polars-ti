# -*- coding: utf-8 -*-
# =============================================================================
# Polars CDL_IDENTICAL3CROWS Implementation
# =============================================================================
...
def cdl_identical3crows(
    ...
    """Polars: Candle Pattern - Identical Three Crows.

    Three consecutive declining black (bearish) candlesticks, each with
    very short lower shadows. Each candle after the first opens at or very
    close to the prior candle's close (the "identical" open distinguishes
    this from regular Three Black Crows).
    ...
    Returns:
        pl.Expr: CDL_IDENTICAL3CROWS expression (-scalar / 0).
    """
    return run_pattern(
        open_,
        high,
