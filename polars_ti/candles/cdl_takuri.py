# -*- coding: utf-8 -*-
# =============================================================================
# Polars CDL_TAKURI Implementation
# =============================================================================
"""Candle Pattern: Takuri (Dragonfly Doji with very long lower shadow)."""
...
def cdl_takuri(
    ...
    Returns:
        pl.Expr: CDL_TAKURI expression (+scalar / 0).
    """
    return run_pattern(
        open_,
        high,
