# -*- coding: utf-8 -*-
# =============================================================================
# Polars CDL_LONGLINE Implementation
# =============================================================================
"""Candle Pattern: Long Line Candle."""
...
def cdl_longline(
    ...
    """Polars: Candle Pattern - Long Line Candle.
    ...
    Returns:
        pl.Expr: CDL_LONGLINE expression (+scalar / -scalar / 0).
    """
    return run_pattern(
        open_,
        high,
