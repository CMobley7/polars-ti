# -*- coding: utf-8 -*-
# =============================================================================
# Polars CDL_SEPARATINGLINES Implementation
# =============================================================================
"""Candle Pattern: Separating Lines."""
...
def cdl_separatinglines(
    ...
    """Polars: Candle Pattern - Separating Lines.
    ...
    Returns:
        pl.Expr: CDL_SEPARATINGLINES expression (+scalar / -scalar / 0).
    """
    return run_pattern(
        open_,
        high,
