# -*- coding: utf-8 -*-
# =============================================================================
# Polars Increasing Implementation (pure Polars)
# =============================================================================
import polars as pl
...
def pl_increasing(
    ...
    Returns True/1 if the series is increasing over a period, False/0 otherwise.
    If strict=True, checks if the series is continuously increasing over the period.

    Args:
        close: Column name or pl.Expr for input values
        length: Period length. Default: 1
        strict: If True, check continuous increase. Default: False
    ...
    Returns:
        pl.Expr: Increasing expression
    """
    close_expr = v_expr(close)
    if close_expr is None:
        return None

    # Apply percent threshold if specified
